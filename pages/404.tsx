    ...
    <>
      ...
      <div style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',background:'#FAF9F7',fontFamily:"'Inter',system-ui,sans-serif"}}>
        <div style={{textAlign:'center',maxWidth:420,padding:'40px 24px'}}>
          <div style={{fontFamily:"'Clash Display',sans-serif",fontSize:72,fontWeight:700,color:'#516756',lineHeight:1,marginBottom:16}}>404</div>
          ...
          <div style={{display:'flex',gap:10,justifyContent:'center'}}>
            <button onClick={()=>router.back()} style={{padding:'10px 20px',borderRadius:10,border:'1px solid #E3DED7',background:'transparent',color:'#516756',fontSize:13,cursor:'pointer',fontFamily:'inherit'}}>← Retour</button>
            <a href="/" style={{padding:'10px 20px',borderRadius:10,background:'#516756',color:'white',fontSize:13,textDecoration:'none',fontWeight:500}}>Accueil →</a>
          </div>
        </div>
      </div>
    </>
