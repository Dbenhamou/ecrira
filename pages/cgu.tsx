  ...
  return (
    <>
      ...
      <div style={{maxWidth:720,margin:'0 auto',padding:'60px 24px',fontFamily:"'Inter',system-ui,sans-serif",color:'#1F2421',lineHeight:1.7}}>
        <a href="/" style={{fontSize:13,color:'#516756',textDecoration:'none',marginBottom:32,display:'block'}}>← Retour</a>
        ...
        <p>Données stockées sur Supabase (UE). Non revendues. Droits RGPD : <a href="mailto:contact@ecrira.com" style={{color:'#516756'}}>contact@ecrira.com</a></p>
        <h2 style={{fontSize:18,fontWeight:600,marginTop:32,marginBottom:8}}>5. Contact</h2>
        <p><a href="mailto:contact@ecrira.com" style={{color:'#516756'}}>contact@ecrira.com</a></p>
      </div>
    </>
  )
}
