        ...
        <div style={{
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            <input
              ...
              onKeyDown={e => e.key === 'Enter' && handleEmailAuth()}
            />
            <button type="button" onClick={()=>setShowPassword(v=>!v)} style={{position:'absolute',right:8,top:'50%',transform:'translateY(-50%)',background:'none',border:'none',cursor:'pointer',padding:6,color:'#3D52A0',display:'flex',alignItems:'center',zIndex:10}} aria-label={showPassword?'Masquer':'Afficher'}>
              {showPassword ? (
