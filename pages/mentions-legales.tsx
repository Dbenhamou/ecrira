  ...
  return (
    <>
      ...
      <div style={{maxWidth:720,margin:'0 auto',padding:'60px 24px',fontFamily:"'Inter',system-ui,sans-serif",color:'#1F2421',lineHeight:1.7}}>
        ...
        <p>David Benhamou — <a href="mailto:contact@ecrira.com" style={{color:'#516756'}}>contact@ecrira.com</a></p>
        ...
        <p>Demandes : <a href="mailto:contact@ecrira.com" style={{color:'#516756'}}>contact@ecrira.com</a></p>
      </div>
    </>
  )
}
